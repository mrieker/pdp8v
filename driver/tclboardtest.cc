...
static int cmd_syncsh (ClientData clientdata, Tcl_Interp *interp, int objc, Tcl_Obj *const objv[])
{
    ...
    static FFBit const ffbits[] = {
        ...
        { "acq[0]",  "Q/aclo/acl",    "_Q/aclo/acl",   0 },
        { "acq[1]",  "Q/aclo/acl",    "_Q/aclo/acl",   1 },
        { "acq[2]",  "Q/aclo/acl",    "_Q/aclo/acl",   2 },
        { "acq[3]",  "Q/aclo/acl",    "_Q/aclo/acl",   3 },
        { "acq[4]",  "Q/acmid/acl",   "_Q/acmid/acl",  0 },
        { "acq[5]",  "Q/acmid/acl",   "_Q/acmid/acl",  1 },
        { "acq[6]",  "Q/acmid/acl",   "_Q/acmid/acl",  2 },
        { "acq[7]",  "Q/acmid/acl",   "_Q/acmid/acl",  3 },
        { "acq[8]",  "Q/achi/acl",    "_Q/achi/acl",   0 },
        { "acq[9]",  "Q/achi/acl",    "_Q/achi/acl",   1 },
        { "acq[10]", "Q/achi/acl",    "_Q/achi/acl",   2 },
        { "acq[11]", "Q/achi/acl",    "_Q/achi/acl",   3 },

        { "defer1q", "_Q/defer1/seq", "Q/defer1/seq",  0 },
        { "defer2q", "_Q/defer2/seq", "Q/defer2/seq",  0 },
        { "defer3q", "_Q/defer3/seq", "Q/defer3/seq",  0 },
        { "exec1q",  "_Q/exec1/seq",  "Q/exec1/seq",   0 },
        { "exec2q",  "_Q/exec2/seq",  "Q/exec2/seq",   0 },
        { "exec3q",  "Q/exec3/seq",   "_Q/exec3/seq",  0 },
        { "fetch1q", "Q/fetch1/seq",  "_Q/fetch1/seq", 0 },
        { "fetch2q", "_Q/fetch2/seq", "Q/fetch2/seq",  0 },
        { "intak1q", "_Q/intak1/seq", "Q/intak1/seq",  0 },

        { "irq[9]",  "Q/ireg09/seq",  "_Q/ireg09/seq", 0 },
        { "irq[10]", "Q/ireg10/seq",  "_Q/ireg10/seq", 0 },
        { "irq[11]", "Q/ireg11/seq",  "_Q/ireg11/seq", 0 },

        { "lnq",     "_Q/lnreg/acl",  "Q/lnreg/acl",   0 },

        { "maq[0]",  "_Q/malo/ma",    "Q/malo/ma",     0 },
        { "maq[1]",  "_Q/malo/ma",    "Q/malo/ma",     1 },
        { "maq[2]",  "_Q/malo/ma",    "Q/malo/ma",     2 },
        { "maq[3]",  "_Q/malo/ma",    "Q/malo/ma",     3 },
        { "maq[4]",  "_Q/mamid/ma",   "Q/mamid/ma",    0 },
        { "maq[5]",  "_Q/mamid/ma",   "Q/mamid/ma",    1 },
        { "maq[6]",  "_Q/mamid/ma",   "Q/mamid/ma",    2 },
        { "maq[7]",  "_Q/mamid/ma",   "Q/mamid/ma",    3 },
        { "maq[8]",  "_Q/mahi/ma",    "Q/mahi/ma",     0 },
        { "maq[9]",  "_Q/mahi/ma",    "Q/mahi/ma",     1 },
        { "maq[10]", "_Q/mahi/ma",    "Q/mahi/ma",     2 },
        { "maq[11]", "_Q/mahi/ma",    "Q/mahi/ma",     3 },

        { "pcq[0]",  "Q/pc00/pc",     "_Q/pc00/pc",    0 },
        { "pcq[1]",  "Q/pc01/pc",     "_Q/pc01/pc",    0 },
        { "pcq[2]",  "Q/pc02/pc",     "_Q/pc02/pc",    0 },
        { "pcq[3]",  "Q/pc03/pc",     "_Q/pc03/pc",    0 },
        { "pcq[4]",  "Q/pc04/pc",     "_Q/pc04/pc",    0 },
        { "pcq[5]",  "Q/pc05/pc",     "_Q/pc05/pc",    0 },
        { "pcq[6]",  "Q/pc06/pc",     "_Q/pc06/pc",    0 },
        { "pcq[7]",  "Q/pc07/pc",     "_Q/pc07/pc",    0 },
        { "pcq[8]",  "Q/pc08/pc",     "_Q/pc08/pc",    0 },
        { "pcq[9]",  "Q/pc09/pc",     "_Q/pc09/pc",    0 },
        { "pcq[10]", "Q/pc10/pc",     "_Q/pc10/pc",    0 },
        { "pcq[11]", "Q/pc11/pc",     "_Q/pc11/pc",    0 },
